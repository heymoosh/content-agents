...
venture/<slug>/
  ...
  intake-context.json            # notes-first only: original notes/history, conversation (user/assistant turns), model fields with basis and exact founder evidence quotes, existing answers, corrections, reviewedBy/reviewedAt
