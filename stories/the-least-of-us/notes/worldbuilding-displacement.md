# Worldbuilding: the displacement opening (Chapter 1 reference)

> Reference for the repositioned Chapter 1: the series opener that follows a NEW everyman through
> the collapse and ends with his recruitment into the faction. Not prose, not a beat sheet. This
> bank holds the central conflict, the real-world anchors that keep it grounded-but-timeless, and
...
> do you owe a system that has quietly stopped needing you, and what are you willing to become to
> be counted again?

Displacement is the mechanism. The captured correctives (democracy, law, the market) are why
there is no peaceful exit. The armed resistance is the tragic answer the saga interrogates. Lena's
closing chapter is the inversion. Chapter 1's only job is to make the reader feel that loop close,
...
difference is that this is the reader's entry wound, lived in real time.

### Door 1, Work: they make you build your own replacement

Real anchors (happening now, use the texture, keep brand names out of the prose):
- Oracle workers (Time, Apr 2026) say they were told to train AI to replace them, then laid off by
  a single email after decades. A technical writer: "They're having you do something, it's
  recorded, and then they're going to replace you with whatever you just built."
- A copywriter's firsthand account titled "I was forced to use AI until the day I was laid off."
- Duolingo told writers and translators to stop making new content and train the system instead,
  then cut them.
- Shopify (Lutke memo, Apr 2025) and Duolingo made it doctrine: prove an AI cannot do the job
  before you are allowed to hire or keep a human, with AI usage baked into performance reviews.

The cruelty is built in. It is framed as innovation and productivity, it is recorded, and the
...
Real anchors:
- Gilens & Page (2014): across 1,779 policy questions (1981 to 2002), economic elites and business
  groups show substantial influence; average citizens show near-zero INDEPENDENT influence.
  Journalists shorthand it as "oligarchy" (the authors are more careful).
- Citizens United (2010) opened unlimited corporate political spending and Super PACs. ~$14B in a
  single federal cycle; ~$2M to win a House seat, ~$20M a Senate seat.
- 466 former members of Congress in the lobbying revolving door; HHS appointees ~15% from industry,
  ~32% return to it; ~$3.45B per year in declared lobbying. The bill that regulates the firm is
  often written by the firm.

Handle with honesty (see the debate below): the door is PAPERED, not slammed. The corrective
exists, is skewed toward money in practice, and is too slow and too captured to reach him before he
is already destitute. He concludes the vote was never the lever he thought it was. That conclusion
is HIS, the character's bitter verdict, not the narrator's assertion.

Timeless version: post-layoff he does the responsible thing. Petitions a rep, shows up to a hearing
on displacement, files with an agency or joins a class action. The corrective already exists on
paper and does nothing in time; the regulator he appeals to used to work for, and will return to,
the company that fired him.

### Door 3, Labor: no floor underneath

He drops to the physical and gig underclass to survive and finds it automating too (warehouses,
...
same beats. Background signals as he descends: storefronts going dark next to "secured community"
enclaves rising; the news euphemism treadmill ("efficiency," "transition," "reskilling"); robot
delivery and private security arriving as normal; everyone around him also told to be grateful and
...
Muxin asked whether the critics of the "US is an oligarchy" finding have merit or are paid off.
Honest answer, and it makes the chapter stronger:

- The ACADEMIC critics have genuine merit and are not paid off. They are mainstream political
  scientists in peer-reviewed journals.
  - Bashir (2015): rich and middle-class preferences correlate at 0.91, so the regression cannot
    cleanly separate their independent effects (multicollinearity). The dramatic "average citizens
    near zero" coefficient may be a statistical artifact, not proof of zero influence.
  - Branham, Soroka & Wlezien (2017): reframed as "who wins when groups disagree?" The rich and
    middle agree ~90% of the time; in the rare disagreements the rich win ~53% to 47%. A real edge,
    not domination.
  - Gilens (2016, "Simulating representation: the devil's in the detail") defended his standard
    errors and argued Bashir's simulation is flawed. The dispute is live, not settled.
  - 2024 systematic review (Elkjaer & Klitgaard, 25 studies, 1,163 estimates): there IS a positive
    income gradient in responsiveness (the rich are better represented), but smaller and more
    variable than "oligarchy" implies.
- The PAID-OFF part is real but one layer up: donor-funded think tanks (Heritage, Center of the
  American Experiment) launder the legitimate academic critique into a clean "the rich do not
  control politics" talking point. Those orgs are funded by the people who benefit from that
  conclusion. Both things are true at once.

Craft consequence: the defensible reality (responsive but money-skewed, captured at the margins,
too slow to save him) is BETTER fiction than the cartoon, and it is critic-proof. We dramatize his
felt experience, never assert the strong claim as settled fact. "It is a rigged oligarchy" is his
conclusion to earn or reject, not the narrator's.

## Craft guardrails (from the seed note, carried forward)

- Do not assert contested economics as settled fact in the prose. Let his lived sense carry it.
- Keep methods non-operational.
- Keep displacement as one strand among several, never a thesis statement in a character's mouth.
- House rule even in fiction: no em dashes.

## Sources

- Oracle / Time: https://time.com/article/2026/04/30/oracle-layoffs-ai-tech-jobs/
- Copywriters / Blood in the Machine: https://www.bloodinthemachine.com/p/i-was-forced-to-use-ai-until-the
- Shopify memo / CNBC: https://www.cnbc.com/2025/04/07/shopify-ceo-prove-ai-cant-do-jobs-before-asking-for-more-headcount.html
- Duolingo & Shopify mandates / Washington Post: https://www.washingtonpost.com/business/2025/06/03/ai-workplace-duolingo-shopify-employees/
- Gilens & Page summary / PNHP: https://pnhp.org/news/gilens-and-page-average-citizens-have-little-impact-on-public-policy/
- Bashir critique (2015), Research & Politics: https://journals.sagepub.com/doi/10.1177/2053168015608896
- Branham, Soroka & Wlezien, "When Do the Rich Win?" (2017): https://onlinelibrary.wiley.com/doi/full/10.1002/polq.12577
- Gilens reply (2016), "Simulating representation": https://journals.sagepub.com/doi/full/10.1177/2053168016654720
