...
| 4 | Universal Time/Mortality Truth | A blunt, undeniable truth about time, aging, or relationships everyone already half-believes | "[Do X] more, [the blunt reason it will not always be possible]." | Sahil Bloom, X: "Call your parents more often—they won't be around forever." |
| 5 | Numbered-List Promise | A scannable payoff stated up front | "[Count] [lessons/things], framed as what Muxin knows at [her current stage] and handed back to [herself at a named earlier stage]." | Sahil Bloom, "35 Things I Know At 35 I Wish I Knew At 25" |
...
| 18 | Communal We-Language Open | Open with shared labor framed as love/joy, not individual grievance | "[Define the purpose of the work in one sentence], naming [the joyful register] inside the definition rather than as its reward." | Valarie Kaur, Bioneers talk: "The meaning of life is to labor for justice with joy." |
...
| 22 | Explicit Rejection of Duty/Guilt Register | Name the finger-wagging tone directly and reject it in the same breath | "[This work] should not feel like [the duty or obligation register the reader expects]. It should feel like [the register Muxin claims instead]." | Eric Liu, Citizen University |
