...
**The "Reach behind it" column, added 2026-08-23.** Muxin asked for these libraries to be weighted
by virality rather than by post count, and this column is that weighting. It states how big the
evidence behind each row actually is, with the metric named every time. It changes nothing else: no
row was re-ranked, demoted or removed, and no gate moved. Three things to know before reading it.
**Rows 1 to 23 have no measured reach at all.** They came from the 2026-08-18 research pass over
creators in Muxin's niches, before any corpus existed, and each was verified as a real shape used by
a real person rather than as a post with a recorded number. Unmeasured is not the same as
worthless, but it is also not evidence of reach, and no row here should ever be argued for on the
grounds that it went viral when nothing behind it was counted. **Rows 24 to 31 were mined from the
corpus and carry real numbers**, from a Substack pair at 3,283 and 2,975 engagements up to a TikTok
single sighting at 896,100 views, with row 25 the exception: neither of its two posts had a
retrievable count, so it has no reach evidence at all. **Views and engagements are never blended.**
Only TikTok, X and YouTube publish a view count; everywhere else the number is likes plus comments
plus shares. Where the corpus never recorded which posts a mined row was built from, the column says
"section band" and gives that platform's admitted range instead of inventing a figure. The full
cross-platform picture, including why the largest sample in the corpus sits behind the smallest
posts, is in `references/post-patterns.md` under "How much reach is actually behind the evidence".

## General patterns (building, solopreneurship, inner journey, civic: mixed register)

| # | Name | Mechanism | Shape | Real example (citation only, do not copy) | Reach behind it |
|---|---|---|---|---|---|
| 1 | Relatable Enemy | Name a frustration the reader already feels, align with them against it before pitching anything | "[Everyday system/obligation] is [struggling/under pressure]. And [reader-aligned reaction]." | Justin Welsh's LinkedIn hook formula (relatable-enemy → aligned hero-statement → curiosity teaser) | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 2 | Retrospective Numbers | Open with a specific number/timeframe from your own track record; context comes after | "[Time ago], I [did X]. We were at [metric], but everyone said [doubt]. Today [outcome]." | Nathan Barry, X, re: ConvertKit funding/MRR history | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 3 | Process Specificity | Declare exactly what you did and how fast, promise a walkthrough | "Here's how I [did X] in [surprisingly short timeframe]." | Pieter Levels, X/thread openers | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 4 | Universal Time/Mortality Truth | A blunt, undeniable truth about time, aging, or relationships everyone already half-believes | "[Do X] more, [the blunt reason it will not always be possible]." | Sahil Bloom, X: "Call your parents more often—they won't be around forever." | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 5 | Numbered-List Promise | A scannable payoff stated up front | "[Count] [lessons/things], framed as what Muxin knows at [her current stage] and handed back to [herself at a named earlier stage]." | Sahil Bloom, "35 Things I Know At 35 I Wish I Knew At 25" | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 6 | Direct Question | Open by asking the reader something that implicates them personally | "[Question that implicates the reader personally]?" | Anne-Laure Le Cunff, Ness Labs: "What do you want to be when you grow up?" | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 7 | Mid-Scene / In Media Res | Drop into a small sensory or emotional moment, no throat-clearing | "[Time marker], I [small sensory/emotional moment]…" | Anne-Laure Le Cunff, Ness Labs newsletter opener | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 8 | Flat Moral-Clarity Claim | A short, undefended declarative sentence that reframes the reader's assumption | "[Short undefended claim reframing the reader's assumption]." | Anand Giridharadas, The.Ink: "I am tired of us being on the defensive." | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 9 | Direct-Address to Named Subgroup | Speak straight to one specific slice of the audience by name | "I want to say to [specific group]: [message]." | Anand Giridharadas, X, address to a named political subgroup | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 10 | Historical Echo Before Pivot | Open with a quote or scene from history/literature, then pivot to the present-day parallel | "[Quote/scene from history or literature]. [Pivot to present-day parallel]." | Heather Cox Richardson, Letters from an American, opens on a Robert Service poem line, pivots to current news | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 11 | Named-Threat Framing | Name the specific mechanism or actor responsible, before explaining the situation | "[Specific mechanism/actor], not [the usual suspect], is [responsible for X]." | David Pepper, Pepperspectives, names state legislatures/gerrymandering as the mechanism | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 12 | Redefinition Claim | Assert what something "really" is, against the common assumption | "The real [thing] isn't [common assumption], it's [reframe]." | Josh Silver, RepresentUs: "The most dangerous currency in American politics today isn't money, it's deception." | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 13 | Named-Audience Callout | Open by naming the exact reader so the right person self-selects in | "If you're [specific reader type]…" | Dickie Bush, Ship 30 for 30 hook framework | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 14 | Curiosity-Gap Teaser | State a claim, then a short unanswered "Why?" that forces the next line | "[Claim]. And [reaction]. Why?" | Justin Welsh's documented LinkedIn formula | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 15 | Confession / Vulnerability Open | Lead with an unflattering personal admission, delay the lesson | "[Unflattering personal admission]. [Lesson delayed to a later line]." | General pattern across the solopreneur/inner-journey set (Arvid Kahl, Sahil Bloom), no single verbatim quote verified, treat as a real but unsourced pattern | No measured reach. Research row, 2026-08-18, no corpus post behind it |

## Joyful-activism patterns (preferred default for civic/social-issues material)

| # | Name | Mechanism | Shape | Real example (citation only, do not copy) | Reach behind it |
|---|---|---|---|---|---|
| 16 | Naming Joy as Strategy, Not Reward | State outright that joy/celebration is the tactic itself, not something earned after winning | "[Joy/celebration] isn't the reward for [winning], it's [the actual strategy]." | Favianna Rodriguez, Latino USA interview, on movement culture being "pain-oriented" | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 17 | Playful Reframe of a Heavy Topic | Turn a civic duty into a verb, game, or activity tied to personal interest | "[Civic/heavy duty] is actually [a game/verb/activity tied to something you already love]." | Baratunde Thurston, "How To Citizen", citizen as a verb (NPR interview, paraphrased coverage, no exact quote verified) | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 18 | Communal We-Language Open | Open with shared labor framed as love/joy, not individual grievance | "[Define the purpose of the work in one sentence], naming [the joyful register] inside the definition rather than as its reward." | Valarie Kaur, Bioneers talk: "The meaning of life is to labor for justice with joy." | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 19 | Celebration-of-Outcome Open | Lead with elation over a real win before any ask or critique | "[Elated/thrilled] to see [specific real win], [detail]." | LaTosha Brown, Black Voters Matter, NPR interview | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 20 | Care/Tending-as-Role Framing | Describe movement work with nurture/tending language, name it as a distinct valued role | "[Role name] is the person who [nurtures/tends] [community/care/joy/connection]." | Deepa Iyer, Social Change Now, the "Caregivers" role | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 21 | Body/Pleasure-Forward Claim | Open from physical feeling-good as the argument itself, not an abstract principle | "[The bodily or pleasurable thing readers are taught to dismiss] is not [the dismissive word used for it]. It is [the stake Muxin claims for it]." | adrienne maree brown, Pleasure Activism: "Feeling good is not frivolous. It is freedom." | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 22 | Explicit Rejection of Duty/Guilt Register | Name the finger-wagging tone directly and reject it in the same breath | "[This work] should not feel like [the duty or obligation register the reader expects]. It should feel like [the register Muxin claims instead]." | Eric Liu, Citizen University | No measured reach. Research row, 2026-08-18, no corpus post behind it |
| 23 | Short Trust/Faith Declarative | A brief, calm line affirming trust in a long process, standing in for hope without over-explaining | "[Short calm affirming line], [standing in for hope about a long process]." | adrienne maree brown, blog post title "i trust the trees" | No measured reach. Research row, 2026-08-18, no corpus post behind it |
