...
export interface StrategyConfig {
  ...
  // Optional: lever C follow-through (epic 2ce597d7) reuses this same config file + loader rather
  // than standing up a second one. Absent on a config that predates the follow-through comparison.
  cadence_follow_thresholds?: { win_ratio: number };
