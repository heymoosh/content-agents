...
import { kickoffVenture, type IntakeAnswers, type VoiceEvidence, type ScorecardInput } from "./intake.js";

// tsx src/venture/new-venture.ts <slug> --stdin
// stdin: {"answers": {...IntakeAnswers}, "voice": {...VoiceEvidence}, "scorecard": {...ScorecardInput}}
